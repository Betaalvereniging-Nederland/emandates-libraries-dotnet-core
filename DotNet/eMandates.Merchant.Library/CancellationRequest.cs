...
namespace eMandates.Merchant.Library
{
    ...
    public class CancellationRequest
    {
        ...
        /// </summary>
        public CancellationRequest(string entranceCode, string language, string eMandateId, string eMandateReason, string debtorReference,
            string debtorBankId, string purchaseId, SequenceType sequenceType, string originalIban, string messageId)
        {
        ...
        /// </summary>
        public CancellationRequest(string entranceCode, string language, string eMandateId, string eMandateReason, string debtorReference,
            string debtorBankId, string purchaseId, SequenceType sequenceType, string originalIban)
        {
            this.EntranceCode = entranceCode;
            this.Language = language;
            this.EMandateId = eMandateId;
